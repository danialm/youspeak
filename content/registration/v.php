...
<div id="register">
    ...
    <form class='bordered' name='register' method='POST' onsubmit='return ValidateRegistration();'>
        ...
        <table style='width:100%'><tr><td>
            ...
            <script>document.register.username.focus()</script>
            
            <span id='label_passone'><label for='passone'>Password</label></span>
            <input type='password' name='passone' id='passone' placeholder='Password' /><br />
            
            <span id='label_passtwo'><label for='passtwo'>Re-Enter Password</label></span>
            <input type='password' name='passtwo' id='passtwo' placeholder='Password' /><br />
